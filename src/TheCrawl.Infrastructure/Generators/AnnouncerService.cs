...
/// <summary>
/// Static fallback announcer. Returns Task to match the async interface
/// that the VERA (Claude API) implementation will fulfil.
/// </summary>
public class AnnouncerService : IAnnouncerService
{
    private static readonly Random _rng = new();

    public Task<string> OnSessionStartAsync(string playerName, string playerClass, CancellationToken ct = default) =>
    ...
    public Task<string> OnKillAsync(string playerName, string enemyName, int killCount, CancellationToken ct = default) =>
        Task.FromResult(Pick([
    ...
    public Task<string> OnPlayerDamagedAsync(string playerName, int damage, int remainingHp, CancellationToken ct = default) =>
        Task.FromResult(Pick([
    ...
    public Task<string> OnDeathAsync(string playerName, int floorsCleared, int killCount, CancellationToken ct = default) =>
        Task.FromResult(Pick([
    ...
    public Task<string> OnFloorDescendAsync(string playerName, int newFloor, CancellationToken ct = default) =>
        Task.FromResult(Pick([
    ...
    public Task<string> OnItemPickupAsync(string playerName, string itemName, CancellationToken ct = default) =>
        Task.FromResult(Pick([
    ...
    public Task<string> OnObjectionSucceedsAsync(string enemyName, CancellationToken ct = default) =>
        Task.FromResult(Pick([
